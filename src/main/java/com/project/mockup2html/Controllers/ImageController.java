...
public class ImageController {
	...
	public static Mat imgPreprocessing(Mat imgMat) {
		...
		Mat bgImgMat = Mat.ones(256, 256, CvType.CV_16U);Core.repeat(bgImgMat, 3, 3, bgImg);Core.multiply(bgImg, new Scalar(255, 255), bgImg);
		...
		Core.divide(bgImg,new Scalar(255, 255), bgImg);
